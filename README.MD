...
| **PUT** `/api/cars/:id`    | Invalid Data Update          | Provide invalid data during update (e.g., invalid `make_model_year_id`). | **400 Bad Request**, validation error messages are returned.            | **Yes**             | N/A                   |
