...
| **POST** `/api/makemodelyear`       | Missing Required Fields   | Omit required fields (e.g., `make`, `model`, `year`).       | **400 Bad Request**, validation error messages are returned.                  | **Yes**             | N/A                   |
...
| **POST** `/api/makemodelyear`       | Invalid Data              | Provide invalid data (e.g., non-integer `year`).            | **400 Bad Request**, validation error messages are returned.                  | **Yes**             | N/A                   |
