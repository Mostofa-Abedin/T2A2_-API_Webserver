...
| **PUT** `/api/makemodelyear/:id`    | Invalid Data Update       | Provide invalid data during update (e.g., invalid `year`).  | **400 Bad Request**, validation error messages are returned.                  | **yes**             | N/A                   |
